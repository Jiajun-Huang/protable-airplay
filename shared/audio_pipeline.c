...
//     {
//         // AirPlay encrypts audio in 16-byte blocks
//         size_t encrypted_len = (payload_len / 16) * 16;

//         if (encrypted_len > sizeof(decrypted_buffer))
//         {
//             fprintf(stderr, "[pipeline] Encrypted payload too large: %zu > %zu\n",
//                     encrypted_len, sizeof(decrypted_buffer));
//             return -1;
//         }
...
//             else
//             {
//                 fprintf(stderr, "[pipeline] Warning: RSA AES-key decrypt failed\n");
//             }
//         }

//         if (!have_key)
//         {
//             memcpy(aes_key, session->aes_key, sizeof(aes_key));
//             have_key = 1;
//         }
