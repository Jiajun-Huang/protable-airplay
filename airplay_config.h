...
#define AIRPLAY_RAOP_TXT_ENTRIES \
    ...
    "am=" AIRPLAY_MODEL_NAME, "sf=0x4", "ek=1"
...
#if AIRPLAY_RTSP_PORT < 1 || AIRPLAY_RTSP_PORT > 65535 || \
    AIRPLAY_AUDIO_PORT < 1 || AIRPLAY_AUDIO_PORT > 65535 || \
    AIRPLAY_CONTROL_PORT < 1 || AIRPLAY_CONTROL_PORT > 65535 || \
    AIRPLAY_TIMING_PORT < 1 || AIRPLAY_TIMING_PORT > 65535
#error "AirPlay service ports must be in 1..65535"
#endif
#if AIRPLAY_AUDIO_PORT == AIRPLAY_CONTROL_PORT || \
    AIRPLAY_AUDIO_PORT == AIRPLAY_TIMING_PORT || AIRPLAY_CONTROL_PORT == AIRPLAY_TIMING_PORT || \
    AIRPLAY_AUDIO_PORT == 5353 || AIRPLAY_CONTROL_PORT == 5353 || AIRPLAY_TIMING_PORT == 5353
#error "AirPlay UDP ports must be distinct and must not use the mDNS port 5353"
#endif
#if AIRPLAY_DEFAULT_BITS_PER_SAMPLE != 16 || \
    AIRPLAY_DEFAULT_CHANNELS < 1 || AIRPLAY_DEFAULT_CHANNELS > 2
